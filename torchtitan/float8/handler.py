...
class Float8Handler:
    def __init__(self, job_config: JobConfig, parallel_dims: ParallelDims):
        ...
        self.use_current_scaling = float8_config.use_current_scaling
    ...
    def convert_to_float8_training(self, model: nn.Module):
        ...
        logger.info(
            f"Added FP8 Observers to *FlashAttention2 modules with use_current_scaling={self.use_current_scaling}."
        )
